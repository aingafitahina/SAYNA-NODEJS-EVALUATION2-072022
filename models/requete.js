...
const querymarketing = ["SELECT nom, prenom, avis, note FROM commentaire, formation WHERE typeformation='marketing' AND typeformation=formation_typeformation LIMIT 1",
    "SELECT nom, prenom, avis, note FROM commentaire, formation WHERE typeformation='marketing' AND typeformation=formation_typeformation LIMIT 1 OFFSET 1",
    "SELECT nom, prenom, avis, note FROM commentaire, formation WHERE typeformation='marketing' AND typeformation=formation_typeformation LIMIT 1 OFFSET 2",
    "SELECT nom, prenom, avis, note FROM commentaire, formation WHERE typeformation='marketing' AND typeformation=formation_typeformation LIMIT 1 OFFSET 3"
]

const queryux = ["SELECT nom, prenom, avis, note FROM commentaire, formation WHERE typeformation='ux' AND typeformation=formation_typeformation LIMIT 1",
    "SELECT nom, prenom, avis, note FROM commentaire, formation WHERE typeformation='ux' AND typeformation=formation_typeformation LIMIT 1 OFFSET 1",
    "SELECT nom, prenom, avis, note FROM commentaire, formation WHERE typeformation='ux' AND typeformation=formation_typeformation LIMIT 1 OFFSET 2",
    "SELECT nom, prenom, avis, note FROM commentaire, formation WHERE typeformation='ux' AND typeformation=formation_typeformation LIMIT 1 OFFSET 3"
]
...
"SELECT nom, prenom, avis, note FROM commentaire, formation WHERE typeformation=formation_typeformation ORDER BY note DESC LIMIT 1 OFFSET 1"]
